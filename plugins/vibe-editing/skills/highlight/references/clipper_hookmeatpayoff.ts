...
[0] Speaker 0: Okay, we've got our next caller up. Let's go. Hello?
[1] Speaker 1: Hi.
...
[37] Speaker 1: There are so many things typically that I could put together. There are so many things. I have no clue about doing this. Maybe a community I'm in is a good place for me to ask because it's something that I know has worked well otherwise in the creative space for friends. So I'm sure that's something I could do. I just wouldn't know where to sell. So I would say this. If if I were you, what I would end up doing is I would sell them the printer
...
[42] Speaker 0: Love that one. Appreciate you all. Alright, what else have we got?
...
[0] Speaker 1: I run a premium catering business for clients celebrating milestone events. We grew about 2,800,000 this year with 40% net profit and approximately 8,000,000 in two years. Let's go. Main constraint, season seasonality. So we do about 65% of our annual revenue in six months. And if I don't solve this, I either say no to demand in summer, or I am supply constrained in sorry. Or I am overstuffed in winter.
...
[20] Speaker 1: Search volume and, like, quarterly drops through winter. So Okay. Back to LTV is still strong at a 12 to one, so we can just spend more. So I'm trying to find I guess, my constraint or my my question my main question becomes I have considered popping up a corporate delivery, like a prepackaged, like, typical corporate catering setting to be a kind of entity under my main catering brand, which would be a year round service because they have a very inverted seasonality to the event side where the corporate to order in more of that delivery, but it's it's I don't wanna get distracted. Like, I'm watch one of your content. I don't wanna change the woman in a red dress because it's a whole new business.
...
[0] TRIM: I run a premium catering business for clients celebrating milestone events. We grew about 2,800,000 this year with 40% net profit and approximately 8,000,000 in two years. Let's go. Main constraint, season seasonality. So we do about 65% of our annual revenue in six months. And if I don't solve this, I either say no to demand in summer, or I am supply constrained Or I am overstuffed in winter.
